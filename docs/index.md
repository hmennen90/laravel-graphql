...
- **Strict quality** — PHP 8.4, PHPStan level 10, `orchestra/testbench`, a
  [GraphQL spec conformance suite](conformance.md), parser fuzzing and Infection
  mutation testing (engine core: 100% mutation coverage, ~79% MSI).
